...
$(function() {
	...
	//hide p.readmore on click by adding hide class and slideDown readmore paragraph 
	$('p.readmore').click(function(){
		$('p.readmore').addClass('hide');
		$('#show-this-on-click').slideDown();
		$('p.readless').removeClass('hide');
	});

	//hide readless and #show-this-on-click 
	$('p.readless').click(function(){
		$('#show-this-on-click').slideUp()
		$('p.readless').addClass('hide');
		$('p.readmore').removeClass('hide');
	});
});